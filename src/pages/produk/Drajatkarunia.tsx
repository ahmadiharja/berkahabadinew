...
import ProductImageOne from '../../assets/images/DK-ORG-12_bg1.jpg';
...
const Drajatkarunia = () => {
  ...
  return (
    <div className="flex-1 overflow-y-auto pt-14 pb-20">
      {/* Product Header */}
      <div className="bg-gray-800 p-4 text-gray-100"> {/* Updated card styles */}
      ...
      {/* Herbs Section */}
      <div className="mt-2 bg-gray-800 p-4 text-gray-100"> {/* Updated card styles */}
      ...
      {/* Testimonials */}
      <div className="mt-2 bg-gray-800 p-4 text-gray-100 mb-24"> {/* Updated card styles */}
